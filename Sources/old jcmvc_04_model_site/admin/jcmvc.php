<?php 
$jcmvc_url_site = JURI::root().'index.php?option=com_jcmvc';
$jcmvc_url_view_first = JURI::root().'index.php?option=com_jcmvc&view=first';
$jcmvc_url_view_site_featured = JURI::root().'index.php?option=com_jcmvc&view=featured';
 ?>
 <hr />
